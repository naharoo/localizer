...
public final class Assertions {
    ...
    private static void throwIllegalArgumentException(final String message, final String... args) {
        throw new IllegalArgumentException(String.format(message, (Object) args));
    }

    private static void throwIllegalStateException(final String message, final String... args) {
