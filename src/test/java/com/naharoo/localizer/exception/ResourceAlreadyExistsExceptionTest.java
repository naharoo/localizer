...
class ResourceAlreadyExistsExceptionTest {
    ...
    @Test
    @DisplayName("ResourceAlreadyExistsException should be successfully created when given correct class, fieldName and fieldValue")
    void with_correctClassAndFieldNameAndFieldValue() {
        ...
        // When
        final ResourceAlreadyExistsException exception = ResourceAlreadyExistsException.with(resourceClass, fieldName, fieldValue);
    ...
    void with_illegalArgs_illegalClass() {
        ...
        // When
        assertThrows(IllegalArgumentException.class, () -> ResourceAlreadyExistsException.with(clazz, fieldName, fieldValue));
    ...
    @Test
    @DisplayName("ResourceAlreadyExistsException should be successfully created when given correct class and identifier")
    void with_correctClassAndMap() {
        ...
        // When
        final ResourceAlreadyExistsException exception = ResourceAlreadyExistsException.with(resourceClass, expectedIdentifiers);
    ...
    void with_illegalArgs_illegalClass_2() {
        ...
        // When
        assertThrows(IllegalArgumentException.class, () -> ResourceAlreadyExistsException.with(clazz, identifiers));
    ...
    void constructMessage() {
        ...
        final String fieldName = "coder";
        final String fieldValue = "asd1dwd";
        final String message = String.format("%s with identifiers [%s: %s] already exists.", resourceClass.getSimpleName(), fieldName, fieldValue);
