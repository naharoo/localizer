...
public class ResourceNotFoundException extends LocalizerException {
    ...
    private ResourceNotFoundException(final Class<?> resourceClass, final Map<String, Object> identifiers) {
        super(constructMessage(resourceClass, identifiers));
        this.resourceClass = resourceClass;
        this.identifiers = identifiers;
    }

    public static ResourceNotFoundException with(final Class<?> resourceClass, final String fieldName, final Object fieldValue) {
    ...
    public static ResourceNotFoundException with(final Class<?> resourceClass, final Map<String, Object> identifiers) {
        expectNotNull(resourceClass, "resourceClass cannot be null.");
        expectNotNull(identifiers, "identifiers cannot be null.");
        return new ResourceNotFoundException(resourceClass, identifiers);
    }
    ...
    private static String constructMessage(final Class<?> resourceClass, final Map<String, Object> identifiers) {
        ...
        messageBuilder.append(identifierString).append("] is not found.");
