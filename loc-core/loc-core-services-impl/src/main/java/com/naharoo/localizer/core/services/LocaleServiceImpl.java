...
import com.naharoo.localizer.core.exceptions.ResourceAlreadyExistsException;
import com.naharoo.localizer.core.repositories.LocaleRepository;
...
public class LocaleServiceImpl implements LocaleService {
    ...
    @Override
    public Locale create(final LocaleModificationRequest creationRequest) {
